...
const TaskTwo = ({ showModal2, setShowModal2 }) => {
  ...
  const handleTaskLinkClick = () => {
    window.open("https://t.me/conceptdeveloper");
  ...
  const handleVerify = async () => {
    ...
    const response = await fetch(
      `https://api.telegram.org/bot7327868388:AAH89ye-KeNy0TcsWFe-ixgXFXKOSRwYDj8/getChatMember?chat_id=-1002245537889&user_id=${id}`    );
