...
export const UserProvider = ({ children }) => {
  ...
  const [level, setLevel] = useState({ id: 1, name: "Bronze", imgUrl: "https://ucarecdn.com/074dadcb-6be1-47e7-92da-28d2bd3a9448/bronze.webp" }); // Initial level as an object with id and name
    ...
    if (telegramUser) {
      ...
      try {
        ...
        const userData = {
          ...
          level: { id: 1, name: "Bronze", imgUrl: "https://ucarecdn.com/074dadcb-6be1-47e7-92da-28d2bd3a9448/bronze.webp" }, // Set the initial level with id and name
          energy: 500,
          ...
          if (referrerDoc.exists()) {
            await updateDoc(referrerRef, {
              referrals: arrayUnion({
                ...
                username: finalUsername,
                balance: 0,
                level: { id: 1, name: "Bronze", imgUrl: "https://ucarecdn.com/074dadcb-6be1-47e7-92da-28d2bd3a9448/bronze.webp" }, // Include level with id and name
              })
            });
  ...
  const updateUserLevel = async (userId, newTapBalance) => {
    let newLevel = { id: 1, name: "Bronze", imgUrl: "https://ucarecdn.com/074dadcb-6be1-47e7-92da-28d2bd3a9448/bronze.webp" };

    if (newTapBalance >= 1000 && newTapBalance < 50000) {
      newLevel = { id: 2, name: "Silver", imgUrl: "https://ucarecdn.com/6725a762-528a-4967-bde1-f4da9f4833ee/sliver.webp" };
    } else if (newTapBalance >= 50000 && newTapBalance < 500000) {
      newLevel = { id: 3, name: "Gold", imgUrl: "https://ucarecdn.com/06204717-97e6-4e54-86b7-6b17a6b59788/gold.webp" };
    } else if (newTapBalance >= 500000 && newTapBalance < 1000000) {
      newLevel = { id: 4, name: "Platinum", imgUrl: "https://ucarecdn.com/11701ad0-9d1a-4081-b474-48d28d5225fa/platinum.webp" };
    } else if (newTapBalance >= 1000000 && newTapBalance < 2500000) {
      newLevel = { id: 5, name: "Diamond", imgUrl: "https://ucarecdn.com/e9cf6a2d-8b21-4703-b6bd-3464f7a00492/diamond.webp" };
    } else if (newTapBalance >= 2500000) {
      newLevel = { id: 6, name: "Master", imgUrl: "https://ucarecdn.com/a18656b8-9d0c-437b-a2dd-65246bb99ef0/master.webp" };
    }
